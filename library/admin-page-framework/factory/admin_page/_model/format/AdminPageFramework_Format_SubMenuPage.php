...
class AdminPageFramework_Format_SubMenuPage extends AdminPageFramework_Format_Base {
    ...
    protected function _getFormattedSubMenuPageArray(array $aSubMenuPage) {
        ...
        return array('href_icon_32x32' => $this->getResolvedSRC($aSubMenuPage['screen_icon'], true), 'screen_icon_id' => $this->getAOrB(in_array($aSubMenuPage['screen_icon'], self::$aScreenIconIDs), $aSubMenuPage['screen_icon'], 'generic'), 'capability' => $this->getElement($aSubMenuPage, 'capability', $this->oFactory->oProp->sCapability), 'order' => $this->getAOrB(is_numeric($aSubMenuPage['order']), $aSubMenuPage['order'], count($this->oFactory->oProp->aPages) * 5 + 10),) + $aSubMenuPage;
    }
}