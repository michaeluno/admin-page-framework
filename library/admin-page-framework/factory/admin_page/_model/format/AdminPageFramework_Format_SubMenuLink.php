...
class AdminPageFramework_Format_SubMenuLink extends AdminPageFramework_Format_SubMenuPage {
    ...
    protected function _getFormattedSubMenuLinkArray(array $aSubMenuLink) {
        ...
        return array('capability' => $this->getElement($aSubMenuLink, 'capability', $this->oFactory->oProp->sCapability), 'order' => isset($aSubMenuLink['order']) && is_numeric($aSubMenuLink['order']) ? $aSubMenuLink['order'] : count($this->oFactory->oProp->aPages) * 5 + 10,) + $aSubMenuLink + self::$aStructure;
    }
}