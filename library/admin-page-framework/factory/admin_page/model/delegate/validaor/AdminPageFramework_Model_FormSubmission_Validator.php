...
class AdminPageFramework_Model_FormSubmission_Validator extends AdminPageFramework_Model_FormSubmission_Validator_Base {
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('AdminPageFramework_Model_FormSubmission_Validator_ContactForm', 'AdminPageFramework_Model_FormSubmission_Validator_ResetConfirm', 'AdminPageFramework_Model_FormSubmission_Validator_Link', 'AdminPageFramework_Model_FormSubmission_Validator_Redirect', 'AdminPageFramework_Model_FormSubmission_Validator_Import', 'AdminPageFramework_Model_FormSubmission_Validator_Export', 'AdminPageFramework_Model_FormSubmission_Validator_Reset', 'AdminPageFramework_Model_FormSubmission_Validator_ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new AdminPageFramework_Model_FormSubmission_Validator_Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
