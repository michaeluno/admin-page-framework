...
class AdminPageFramework_Property_PostType extends AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        switch ($this->_getCallerType($sCallerPath)) {
            case 'theme':
                add_action('after_switch_theme', array($this, '_replyToFlushRewriteRules'));
            break;
            case 'plugin':
                register_activation_hook($sCallerPath, array($this, '_replyToFlushRewriteRules'));
                register_deactivation_hook($sCallerPath, array($this, '_replyToFlushRewriteRules'));
            break;
        }
    }
