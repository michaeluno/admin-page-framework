...
class AdminPageFramework_PostType_Model__SubMenuOrder extends AdminPageFramework_FrameworkUtility {
    ...
    private function _getPostTypeMenuLinkSlugs() {
        ...
        $_aLinkSlugs = array('edit.php?post_type=' . $this->oFactory->oProp->sPostType => $_nSubMenuOrderManage, 'post-new.php?post_type=' . $this->oFactory->oProp->sPostType => $_nSubMenuOrderAddNew,);
