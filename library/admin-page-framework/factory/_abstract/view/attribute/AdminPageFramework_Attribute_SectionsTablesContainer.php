<?php
class AdminPageFramework_Attribute_SectionsTablesContainer extends AdminPageFramework_Attribute_Base {
    ...
    private function _getDynamicElementArguments($aSectionset) {
        ...
        $_oSectionNameGenerator = new AdminPageFramework_Generate_SectionName($aSectionset, $aSectionset['_caller_object']->oProp->aFieldCallbacks['hfSectionName']);
