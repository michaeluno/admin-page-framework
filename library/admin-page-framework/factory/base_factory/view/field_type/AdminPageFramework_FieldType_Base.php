...
abstract class AdminPageFramework_FieldType_Base extends AdminPageFramework_WPUtility {
    ...
    protected function geFieldOutput(array $aFieldset) {
        ...
        $_oFieldset = new AdminPageFramework_FormFieldset($aFieldset, $_aOptions, $_oCaller->getFieldErrors(), $_oCaller->oProp->aFieldTypeDefinitions, $_oCaller->oMsg, $_oCaller->oProp->aFieldCallbacks);
