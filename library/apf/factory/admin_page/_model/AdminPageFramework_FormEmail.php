...
class AdminPageFramework_FormEmail extends AdminPageFramework_FrameworkUtility {
    ...
    public function send() {
        ...
        $_bSent = wp_mail($this->_getEmailArgument($_aInputs, $_aEmailOptions, 'to', $_sSubmitSectionID), $this->_getEmailArgument($_aInputs, $_aEmailOptions, 'subject', $_sSubmitSectionID), $_bIsHTML ? $this->getReadableListOfArrayAsHTML(( array )$this->_getEmailArgument($_aInputs, $_aEmailOptions, 'message', $_sSubmitSectionID)) : $this->getReadableListOfArray(( array )$this->_getEmailArgument($_aInputs, $_aEmailOptions, 'message', $_sSubmitSectionID)), $this->_getEmailArgument($_aInputs, $_aEmailOptions, 'headers', $_sSubmitSectionID), $this->___formatAttachments($this->_getEmailArgument($_aInputs, $_aEmailOptions, 'attachments', $_sSubmitSectionID)));
