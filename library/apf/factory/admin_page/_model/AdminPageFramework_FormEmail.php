...
class AdminPageFramework_FormEmail extends AdminPageFramework_FrameworkUtility {
    ...
    public function send() {
        ...
        $_bSent = wp_mail($this->___getEmailArgument($_aInputs, $_aEmailOptions, 'to', $_sSubmitSectionID), $this->___getEmailArgument($_aInputs, $_aEmailOptions, 'subject', $_sSubmitSectionID), $_bIsHTML ? $this->getReadableListOfArrayAsHTML(( array )$this->___getEmailArgument($_aInputs, $_aEmailOptions, 'message', $_sSubmitSectionID)) : $this->getReadableListOfArray(( array )$this->___getEmailArgument($_aInputs, $_aEmailOptions, 'message', $_sSubmitSectionID)), $this->___getEmailArgument($_aInputs, $_aEmailOptions, 'headers', $_sSubmitSectionID), $this->___getAttachmentsFormatted($this->___getEmailArgument($_aInputs, $_aEmailOptions, 'attachments', $_sSubmitSectionID)));
