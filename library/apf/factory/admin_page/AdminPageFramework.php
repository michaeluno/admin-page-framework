...
abstract class AdminPageFramework_Router extends AdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        $this->oProp = isset($this->oProp) ? $this->oProp : new AdminPageFramework_Property_admin_page($this, $sCallerPath, get_class($this), $sOptionKey, $sCapability, $sTextDomain);
    ...
    private function _getCallbackName($sMethodName, $sPageSlug, array $aKnownMethodPrefixes = array()) {
        if (in_array($sMethodName, array($this->oProp->sClassHash . '_page_' . $sPageSlug))) {
            return $sMethodName;
        }
