...
class AdminPageFramework_Form_View___Fieldset extends AdminPageFramework_Form_View___Fieldset_Base {
    ...
    private function _getNestedFieldsetsBySubFieldIndex($iIndex, array $aField, array $aParentFieldset, $bLastElement = false, $bHasSubFields = false) {
        ...
        $_oSubFieldFormatter = new AdminPageFramework_Form_Model___Format_EachField($aParentFieldset, $iIndex, $this->aCallbacks, $bLastElement);
        ...
        return $aParentFieldset['before_field'] . "<div " . $_oFieldAttribute->get() . ">" . $_sNestedFieldsetsOutput . "</div>" . $aParentFieldset['after_field'];
    }
