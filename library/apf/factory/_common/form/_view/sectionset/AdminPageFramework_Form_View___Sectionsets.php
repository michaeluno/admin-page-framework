...
class AdminPageFramework_Form_View___Sectionsets extends AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        return $this->___getSpinnerOutput($_sOutput) . "<div id='{$_sElementID}' class='admin-page-framework-sctionsets admin-page-framework-form-js-on'>" . $_sOutput . $_oDebugInfo->get() . "</div>";
    }
