...
class AdminPageFramework_Form_View___Attribute_Field extends AdminPageFramework_Form_View___Attribute_FieldContainer_Base {
    ...
    protected function _getAttributes() {
        $_sFieldTypeSelector = $this->aArguments['type'] ? " admin-page-framework-field-{$this->aArguments['type']}" : '';
        $_sNestedFieldSelector = $this->hasNestedFields($this->aArguments) ? ' with-nested-fields' : ' without-nested-fields';
        return array('id' => $this->aArguments['_field_container_id'], 'data-type' => $this->aArguments['type'], 'class' => "admin-page-framework-field{$_sFieldTypeSelector}{$_sNestedFieldSelector}" . $this->getAOrB($this->aArguments['attributes']['disabled'], ' disabled', '') . $this->getAOrB($this->aArguments['_is_sub_field'], ' admin-page-framework-subfield', ''));
    }
}
