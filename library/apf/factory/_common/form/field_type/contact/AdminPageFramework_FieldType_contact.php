...
class AdminPageFramework_FieldType_contact extends AdminPageFramework_FieldType_submit {
    ...
    protected function construct() {
        $this->aDefaultKeys = array('email' => array('to' => null, 'subject' => null, 'message' => null, 'headers' => null, 'attachments' => null, 'is_html' => true, 'from' => null, 'name' => null,), 'system_message' => array('success' => $this->oMsg->get('email_sent'), 'failure' => $this->oMsg->get('email_could_not_send'), 'error' => $this->oMsg->get('nonce_verification_failed'),),) + $this->aDefaultKeys;
    ...
    protected function getEnqueuingStyles() {
        return array(array('src' => dirname(__FILE__) . '/css/contact.css',),);
    }
    protected function getEnqueuingScripts() {
        return array(array('handle_id' => 'admin-page-framework-contact-field-type', 'src' => dirname(__FILE__) . '/js/contact.bundle.js', 'in_footer' => true, 'dependencies' => array('jquery',), 'translation_var' => 'AdminPageFrameworkContactFieldType', 'translation' => array('nonce' => wp_create_nonce(get_class($this)), 'action' => $this->___sAction, 'messages' => array('requiredField' => $this->oMsg->get('please_fill_out_this_field'),),),),);
    }
