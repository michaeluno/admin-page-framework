...
JAVASCRIPT;
    ...
    protected function getStyles() {
        return ".admin-page-framework-field-import input {margin-right: 0.5em;}.admin-page-framework-field-import,.admin-page-framework-field-import .admin-page-framework-input-label-container {width: 100%;}.admin-page-framework-field-import label,.form-table td fieldset.admin-page-framework-fieldset .admin-page-framework-field-import label { display: inline-block; width: auto;vertical-align: middle;}";
    }
