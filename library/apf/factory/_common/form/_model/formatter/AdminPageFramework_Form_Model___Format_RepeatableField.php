...
class AdminPageFramework_Form_Model___Format_RepeatableSection extends AdminPageFramework_FrameworkUtility {
    ...
    static protected $_aStructure_Disabled = array('label' => 'The ability of repeating sections is disabled.', 'caption' => 'Warning', 'box_width' => 300, 'box_height' => 100,);
    ...
    public function get() {
        ...
        if (!empty($_aArguments['disabled'])) {
            $_aArguments['disabled'] = $_aArguments['disabled'] + array('label' => $this->_getDefaultMessage(), 'caption' => $this->_oMsg->get('warning_caption'),) + self::$_aStructure_Disabled;
        }
        return $_aArguments;
    }
