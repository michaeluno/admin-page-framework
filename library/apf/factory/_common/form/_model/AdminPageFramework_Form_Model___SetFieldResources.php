...
class AdminPageFramework_Form_Model___SetFieldResources extends AdminPageFramework_Form_Base {
    ...
    private function ___setCommonFormExternalStylesheets() {
        $this->aResources['src_styles'][] = array('handle_id' => 'admin-page-framework-form', 'src' => AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form.css',);
        $this->aResources['src_styles'][] = array('handle_id' => 'admin-page-framework-form-ie', 'src' => AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form-ie.css', 'conditional' => 'IE',);
        if (version_compare($GLOBALS['wp_version'], '5.3', '>=')) {
            $this->aResources['src_styles'][] = array('handle_id' => 'admin-page-framework-form-5_3-or-above', 'src' => AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form-5_3-or-above.css',);
        }
        if (version_compare($GLOBALS['wp_version'], '4.7', '>=')) {
            $this->aResources['src_styles'][] = array('handle_id' => 'admin-page-framework-form-4_7-or-above', 'src' => AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form-4_7-or-above.css',);
        }
        if (version_compare($GLOBALS['wp_version'], '3.8', '<')) {
            $this->aResources['src_styles'][] = array('handle_id' => 'admin-page-framework-form-4_8-below', 'src' => AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form-3_8-below.css',);
        }
        if (version_compare($GLOBALS['wp_version'], '3.8', '>=')) {
            $this->aResources['src_styles'][] = array('handle_id' => 'admin-page-framework-form-3_8-or-above', 'src' => AdminPageFramework_Registry::$sDirPath . '/factory/_common/form/asset/css/form-3_8-or-above.css',);
        }
    }
