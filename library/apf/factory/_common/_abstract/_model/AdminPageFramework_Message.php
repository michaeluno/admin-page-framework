...
class AdminPageFramework_Message
{
    ...
    private function ___doDummy()
    {
        ...
        __('Submit the form.', 'admin-page-framework');
        __('Please check this box if you want to proceed.', 'admin-page-framework');
        __('No file is selected.', 'admin-page-framework');
        __('Please fill out this field.', 'admin-page-framework');
    }
}
