...
class AdminPageFramework_Debug extends AdminPageFramework_FrameworkUtility {
    ...
    static public function getDetails($mValue, $bEscape = true) {
        $_sValueWithDetails = self::_getArrayRepresentationSanitized(self::_getLegible($mValue));
    ...
    static public function log($mValue, $sFilePath = null) {
        ...
        file_put_contents(self::_getLogFilePath($sFilePath, $_sCallerClass), self::_getLogHeadingLine($_fCurrentTimeStamp, round($_fCurrentTimeStamp - $_fPreviousTimeStamp, 3), $_sCallerClass, $_sCallerFunction) . PHP_EOL . self::_getLegible($mValue) . PHP_EOL . PHP_EOL, FILE_APPEND);
    ...
    static public function getAsString($mValue) {
        ...
        $mValue = is_array($mValue) ? self::_getArrayMappedRecursive(self::_getSliceByDepth($mValue, 10), array(__CLASS__, '_getObjectName')) : $mValue;
    ...
    static public function _getLegibleArray(array $aArray) {
        return self::_getArrayMappedRecursive(self::_getSliceByDepth($aArray, 10), array(__CLASS__, '_getLegibleValue'));
    }
