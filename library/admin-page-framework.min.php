<?php 
/**
	Admin Page Framework - Minified Version v3.5.0b08 by Michael Uno 
...
class AdminPageFramework_WPReadmeParser {
    ...
    public function __construct($sFilePath = '', array $aReplacements = array(), array $aCallbacks = array()) {
        ...
        $this->_aContents = $this->sText ? $this->_getSplitContentsBySection($this->sText) : array();
    ...
    public function getRawSection($sSectionName) {
        ...
        return false === $_iIndex ? '' : $this->_aContents[$_iIndex + 1];
    }
