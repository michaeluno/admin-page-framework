<?php 
/**
	Admin Page Framework - Minified Version v3.5.3b11 by Michael Uno 
...
class AdminPageFramework_FieldType_submit extends AdminPageFramework_FieldType {
    ...
    private function _getHiddenInput_Redirect(array $aField) {
        ...
        return $this->generateHTMLTag('input', array('type' => 'hidden', 'name' => "__submit[{$aField['input_id']}][redirect_url]", 'value' => $aField['redirect_url'],));
    }
    private function _getHiddenInput_Href(array $aField) {
        if (!$aField['href']) {
            return '';
        }
        return $this->generateHTMLTag('input', array('type' => 'hidden', 'name' => "__submit[{$aField['input_id']}][link_url]", 'value' => $aField['href'],));
    }
...
class AdminPageFramework_FieldType_system extends AdminPageFramework_FieldType {
    ...
    private function _getFormattedSystemInformation($asCustomData) {
        ...
        $_aData = $_aData + array('Admin Page Framework' => isset($_aData['Admin Page Framework']) ? null : AdminPageFramework_Registry::getInfo(), 'WordPress' => $this->_getSiteInfo(!isset($_aData['WordPress'])), 'PHP' => $this->_getPHPInfo(!isset($_aData['PHP'])), 'PHP Error Log' => $this->_getPHPErrorLog(!isset($_aData['PHP Error Log'])), 'MySQL' => isset($_aData['MySQL']) ? null : $this->getMySQLInfo(), 'MySQL Error Log' => $this->_getMySQLErrorLog(!isset($_aData['MySQL Error Log'])), 'Server' => $this->_getWebServerInfo(!isset($_aData['Server'])), 'Browser' => $this->_getClientInfo(!isset($_aData['Browser'])),);
