<?php 
/**
	Admin Page Framework - Minified Version v3.5.3b30 by Michael Uno 
...
abstract class AdminPageFramework_Factory_Router {
    ...
    protected function _getFormInstance($oProp) {
        $_FormsClassName = in_array($oProp->sFieldsType, array('page', 'network_admin_page')) ? 'AdminPageFramework_FormElement_Page' : 'AdminPageFramework_FormElement';
        if (in_array($oProp->sFieldsType, array('page', 'network_admin_page', 'post_meta_box', 'post_type')) && $oProp->bIsAdminAjax) {
            return null;
        }
        return new $_FormsClassName($oProp->sFieldsType, $oProp->sCapability, $this);
    }
