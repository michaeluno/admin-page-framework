<?php 
/**
	Admin Page Framework - Minified Version v3.5.3b07 by Michael Uno 
...
abstract class AdminPageFramework_Form_Model_Export extends AdminPageFramework_Form_Model_Import {
    ...
    private function _getFilteredExportingData(array $aArguments, $mData) {
        return $this->oUtil->addAndApplyFilters($this, array('export_' . $aArguments['class_name'] . '_' . $aArguments['pressed_input_id'], $aArguments['section_id'] ? 'export_' . $aArguments['class_name'] . '_' . $aArguments['section_id'] . '_' . $aArguments['pressed_field_id'] : 'export_' . $aArguments['class_name'] . '_' . $aArguments['pressed_field_id'], $aArguments['tab_slug'] ? 'export_' . $aArguments['page_slug'] . '_' . $aArguments['tab_slug'] : null, 'export_' . $aArguments['page_slug'], 'export_' . $aArguments['class_name']), $mData, $aArguments['pressed_field_id'], $aArguments['pressed_input_id'], $this);
    }
    private function _getExportFileName(array $aArguments, $sExportFileName, $mData) {
        return $this->oUtil->addAndApplyFilters($this, array('export_name_' . $aArguments['class_name'] . '_' . $aArguments['pressed_input_id'], 'export_name_' . $aArguments['class_name'] . '_' . $aArguments['pressed_field_id'], $aArguments['section_id'] ? 'export_name_' . $aArguments['class_name'] . '_' . $aArguments['section_id'] . '_' . $aArguments['pressed_field_id'] : 'export_name_' . $aArguments['class_name'] . '_' . $aArguments['pressed_field_id'], $aArguments['tab_slug'] ? 'export_name_' . $aArguments['page_slug'] . '_' . $aArguments['tab_slug'] : null, 'export_name_' . $aArguments['page_slug'], 'export_name_' . $aArguments['class_name']), $sExportFileName, $aArguments['pressed_field_id'], $aArguments['pressed_input_id'], $mData, $this);
    }
    private function _getExportFormatType(array $aArguments, $sExportFileFormat) {
        return $this->oUtil->addAndApplyFilters($this, array('export_format_' . $aArguments['class_name'] . '_' . $aArguments['pressed_input_id'], 'export_format_' . $aArguments['class_name'] . '_' . $aArguments['pressed_field_id'], $aArguments['section_id'] ? 'export_format_' . $aArguments['class_name'] . '_' . $aArguments['section_id'] . '_' . $aArguments['pressed_field_id'] : 'export_format_' . $aArguments['class_name'] . '_' . $aArguments['pressed_field_id'], $aArguments['tab_slug'] ? 'export_format_' . $aArguments['page_slug'] . '_' . $aArguments['tab_slug'] : null, 'export_format_' . $aArguments['page_slug'], 'export_format_' . $aArguments['class_name']), $sExportFileFormat, $aArguments['pressed_field_id'], $aArguments['pressed_input_id'], $this);
    }
}
...
abstract class AdminPageFramework_Page_View extends AdminPageFramework_Page_View_MetaBox {
    ...
    private function _getPageHeadingtabNavigationBarPageItem(array $aSubPage, $sCurrentPageSlug) {
        ...
        return "<a " . $this->oUtil->generateAttributes(array('class' => $this->oUtil->generateClassAttribute('nav-tab', $sCurrentPageSlug === $aSubPage['page_slug'] ? 'nav-tab-active' : ''), 'href' => esc_url($this->oUtil->getQueryAdminURL(array('page' => $aSubPage['page_slug'], 'tab' => false), $this->oProp->aDisallowedQueryKeys)),)) . ">" . $aSubPage['title'] . "</a>";
    }
    ...
    private function _getInPageTabs($sCurrentPageSlug, $sTag = 'h3') {
        $_aInPageTabs = isset($this->oProp->aInPageTabs[$sCurrentPageSlug]) ? $this->oProp->aInPageTabs[$sCurrentPageSlug] : array();
    ...
    private function _getInPageTabNavigationBarItem($sTitle, array $aInPageTab, $sInPageTabSlug, $sCurrentPageSlug, $sCurrentTabSlug) {
        ...
        return "<a " . $this->oUtil->generateAttributes(array('class' => $this->oUtil->generateClassAttribute('nav-tab', $sCurrentTabSlug === $sInPageTabSlug ? "nav-tab-active" : ""), 'href' => esc_url(isset($aInPageTab['url']) ? $aInPageTab['url'] : $this->oUtil->getQueryAdminURL(array('page' => $sCurrentPageSlug, 'tab' => $sInPageTabSlug), $this->oProp->aDisallowedQueryKeys)),)) . ">" . $sTitle . "</a>";
    }
...
abstract class AdminPageFramework_Form_Model_Import extends AdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        ...
        $this->setSettingNotice($_bEmpty ? $this->oMsg->get('not_imported_data') : $this->oMsg->get('imported_data'), $_bEmpty ? 'error' : 'updated', $this->oProp->sOptionKey, false);
    ...
    private function _getImportMIMEType(array $aArguments) {
        return $this->oUtil->addAndApplyFilters($this, array('import_mime_types_' . $aArguments['class_name'] . '_' . $aArguments['pressed_input_id'], $aArguments['section_id'] ? 'import_mime_types_' . $aArguments['class_name'] . '_' . $aArguments['section_id'] . '_' . $aArguments['pressed_field_id'] : 'import_mime_types_' . $aArguments['class_name'] . '_' . $aArguments['pressed_field_id'], $aArguments['section_id'] ? 'import_mime_types_' . $aArguments['class_name'] . '_' . $aArguments['section_id'] : null, $aArguments['tab_slug'] ? 'import_mime_types_' . $aArguments['page_slug'] . '_' . $aArguments['tab_slug'] : null, 'import_mime_types_' . $aArguments['page_slug'], 'import_mime_types_' . $aArguments['class_name'],), array('text/plain', 'application/octet-stream'), $aArguments['pressed_field_id'], $aArguments['pressed_input_id'], $this);
    }
    private function _getImportFormatType(array $aArguments, $sFormatType) {
        return $this->oUtil->addAndApplyFilters($this, array('import_format_' . $aArguments['class_name'] . '_' . $aArguments['pressed_input_id'], $aArguments['section_id'] ? 'import_format_' . $aArguments['class_name'] . '_' . $aArguments['section_id'] . '_' . $aArguments['pressed_field_id'] : 'import_format_' . $aArguments['class_name'] . '_' . $aArguments['pressed_field_id'], $aArguments['section_id'] ? 'import_format_' . $aArguments['class_name'] . '_' . $aArguments['section_id'] : null, $aArguments['tab_slug'] ? 'import_format_' . $aArguments['page_slug'] . '_' . $aArguments['tab_slug'] : null, 'import_format_' . $aArguments['page_slug'], 'import_format_' . $aArguments['class_name']), $sFormatType, $aArguments['pressed_field_id'], $aArguments['pressed_input_id'], $this);
    }
    private function _getImportOptionKey(array $aArguments, $sImportOptionKey) {
        return $this->oUtil->addAndApplyFilters($this, array('import_option_key_' . $aArguments['class_name'] . '_' . $aArguments['pressed_input_id'], $aArguments['section_id'] ? 'import_option_key_' . $aArguments['class_name'] . '_' . $aArguments['section_id'] . '_' . $aArguments['pressed_field_id'] : 'import_option_key_' . $aArguments['class_name'] . '_' . $aArguments['pressed_field_id'], $aArguments['section_id'] ? 'import_option_key_' . $aArguments['class_name'] . '_' . $aArguments['section_id'] : null, $aArguments['tab_slug'] ? 'import_option_key_' . $aArguments['page_slug'] . '_' . $aArguments['tab_slug'] : null, 'import_option_key_' . $aArguments['page_slug'], 'import_option_key_' . $aArguments['class_name']), $sImportOptionKey, $aArguments['pressed_field_id'], $aArguments['pressed_input_id'], $this);
    }
    private function _getFilteredImportData(array $aArguments, $mData, $aStoredOptions, $sFormatType, $sImportOptionKey) {
        return $this->oUtil->addAndApplyFilters($this, array('import_' . $aArguments['class_name'] . '_' . $aArguments['pressed_input_id'], $aArguments['section_id'] ? 'import_' . $aArguments['class_name'] . '_' . $aArguments['section_id'] . '_' . $aArguments['pressed_field_id'] : 'import_' . $aArguments['class_name'] . '_' . $aArguments['pressed_field_id'], $aArguments['section_id'] ? 'import_' . $aArguments['class_name'] . '_' . $aArguments['section_id'] : null, $aArguments['tab_slug'] ? 'import_' . $aArguments['page_slug'] . '_' . $aArguments['tab_slug'] : null, 'import_' . $aArguments['page_slug'], 'import_' . $aArguments['class_name']), $mData, $aStoredOptions, $aArguments['pressed_field_id'], $aArguments['pressed_input_id'], $sFormatType, $sImportOptionKey, $aArguments['should_merge'] . $this);
    }
}
...
class AdminPageFramework_FormField extends AdminPageFramework_FormField_Base {
    ...
    private function _getFieldTypeDefinition($sFieldTypeSlug) {
        return isset($this->aFieldTypeDefinitions[$sFieldTypeSlug]) ? $this->aFieldTypeDefinitions[$sFieldTypeSlug] : $this->aFieldTypeDefinitions['default'];
    }
    private function _getFormatedFieldDefinitionArray(array $aField, $isIndex, array $aCallbacks, $aFieldTypeDefinition) {
        ...
        $aField['_input_name_flat'] = $this->_getFlatInputName($aField, $aField['_is_multiple_fields'] ? $isIndex : '', $aCallbacks['hfNameFlat']);
    ...
    private function _getFieldAttributes(array $aField) {
        return array('id' => $aField['_field_container_id'], 'data-type' => "{$aField['type']}", 'data-id_model' => $aField['_fields_container_id_model'], 'class' => "admin-page-framework-field admin-page-framework-field-{$aField['type']}" . ($aField['attributes']['disabled'] ? ' disabled' : null) . ($aField['_is_sub_field'] ? ' admin-page-framework-subfield' : null),);
    }
    private function _getDelimiter(array $aField, $bIsLastElement) {
        return !$aField['delimiter'] ? '' : "<div " . $this->generateAttributes(array('class' => 'delimiter', 'id' => "delimiter-{$aField['input_id']}", 'style' => $bIsLastElement ? "display:none;" : "",)) . ">" . $aField['delimiter'] . "</div>";
    }
    ...
    private function _fillSubFields(array & $aSubFields, array $aFirstField) {
        foreach ($aSubFields as & $_aSubField) {
            $_aLabel = isset($_aSubField['label']) ? $_aSubField['label'] : (isset($aFirstField['label']) ? $aFirstField['label'] : null);
    ...
    private function _setSavedFieldsValue(array & $aFields, $mSavedValue, $aField) {
        ...
        foreach ($aFields as $_iIndex => & $_aThisField) {
            $_aThisField['_saved_value'] = isset($mSavedValue[$_iIndex]) ? $mSavedValue[$_iIndex] : null;
    ...
    private function _getDropDownList($sInputID, array $aLabels, array $aAttributes) {
        ...
        foreach ($aLabels as $__sKey => $__asLabel) {
            if (is_array($__asLabel)) {
                $_aOutput[] = $this->_getOptGroup($aAttributes, $sInputID, $__sKey, $__asLabel);
                continue;
            }
            $_aOutput[] = $this->_getOptionTag($__asLabel, $this->_getOptionTagAttributes($aAttributes, $sInputID, $__sKey, $this->getAsArray($aAttributes['value'])));
        }
        return implode(PHP_EOL, $_aOutput);
    }
    private function _getOptGroup(array $aAttributes, $sInputID, $sKey, $asLabel) {
        $_aOptGroupAttributes = isset($aAttributes['optgroup'][$sKey]) && is_array($aAttributes['optgroup'][$sKey]) ? $aAttributes['optgroup'][$sKey] + $aAttributes['optgroup'] : $aAttributes['optgroup'];
        $_aOptGroupAttributes = array('label' => $sKey,) + $_aOptGroupAttributes;
        return "<optgroup " . $this->generateAttributes($_aOptGroupAttributes) . ">" . $this->_getDropDownList($sInputID, $asLabel, $aAttributes) . "</optgroup>";
    }
    private function _getOptionTagAttributes(array $aAttributes, $sInputID, $sKey, $aValues) {
        $aValues = isset($aAttributes['option'][$sKey]['value']) ? $aAttributes['option'][$sKey]['value'] : $aValues;
        return array('id' => $sInputID . '_' . $sKey, 'value' => $sKey, 'selected' => in_array(( string )$sKey, $aValues) ? 'selected' : null,) + (isset($aAttributes['option'][$sKey]) && is_array($aAttributes['option'][$sKey]) ? $aAttributes['option'][$sKey] + $aAttributes['option'] : $aAttributes['option']);
    }
...
class AdminPageFramework_FieldType_size extends AdminPageFramework_FieldType_select {
    ...
    private function _getNumberInputPart(array $aField, array $aBaseAttributes) {
        ...
        return "<label " . $this->generateAttributes($_aSizeLabelAttributes) . ">" . $this->getFieldElementByKey($aField['before_label'], 'size') . ($aField['label'] && !$aField['repeatable'] ? "<span class='admin-page-framework-input-label-string' style='min-width:" . $this->sanitizeLength($aField['label_min_width']) . ";'>" . $aField['label'] . "</span>" : "") . "<input " . $this->generateAttributes($_aSizeAttributes) . " />" . $this->getFieldElementByKey($aField['after_input'], 'size') . "</label>";
    }
    private function _getUnitSelectInput(array $aField, array $aBaseAttributes) {
        ...
        return "<label " . $this->generateAttributes(array('for' => $_aUnitAttributes['id'], 'class' => $_aUnitAttributes['disabled'] ? 'disabled' : null,)) . ">" . $this->getFieldElementByKey($aField['before_label'], 'unit') . $_oUnitInput->get() . $this->getFieldElementByKey($aField['after_input'], 'unit') . "<div class='repeatable-field-buttons'></div>" . "</label>";
    }
    private function _getUnitAttributes(array $aField, array $aBaseAttributes) {
        ...
        return array('type' => 'select', 'id' => $aField['input_id'] . '_' . 'unit', 'multiple' => $_bIsMultiple ? 'multiple' : null, 'name' => $_bIsMultiple ? "{$aField['_input_name']}[unit][]" : "{$aField['_input_name']}[unit]", 'value' => isset($aField['value']['unit']) ? $aField['value']['unit'] : '',) + $this->getFieldElementByKey($aField['attributes'], 'unit', $this->aDefaultKeys['attributes']['unit']) + $aBaseAttributes;
    }
    ...
    private function _getSizeAttributes(array $aField, array $aBaseAttributes) {
        return array('type' => 'number', 'id' => $aField['input_id'] . '_' . 'size', 'name' => $aField['_input_name'] . '[size]', 'value' => isset($aField['value']['size']) ? $aField['value']['size'] : '',) + $this->getFieldElementByKey($aField['attributes'], 'size', $this->aDefaultKeys['attributes']['size']) + $aBaseAttributes;
    }
}
