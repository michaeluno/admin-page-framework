<?php 
/**
	Admin Page Framework - Minified Version v3.5.3b15 by Michael Uno 
...
abstract class AdminPageFramework_Utility_Array extends AdminPageFramework_Utility_String {
    ...
    static public function getElement($aSubject, $aisKey, $mDefault = null) {
        return self::getArrayValueByArrayKeys($aSubject, self::getAsArray($aisKey, true), $mDefault);
    }
    static public function getElementAsArray($aSubject, $isKey, $vDefault = null) {
        return self::getAsArray(self::getElement($aSubject, $isKey, $vDefault), true);
    }
    ...
    public static function castArrayContents($aModel, $aSubject) {
        ...
        foreach ($aModel as $sKey => $_v) {
            $aMod[$sKey] = self::getElement($aSubject, $sKey, null);
        }
        return $aMod;
    }
...
class AdminPageFramework_FieldType_system extends AdminPageFramework_FieldType {
    ...
    private function _getTooLongOrAcceptable($bTooLongOrAccepted) {
        return $bTooLongOrAccepted ? __('Too Long', 'admin-page-framework') : __('Acceptable', 'admin-page-frmework');
    }
}
...
class AdminPageFramework_Input_select extends AdminPageFramework_Input_Base {
    ...
    public function get() {
        ...
        return "<{$this->aOptions['input_container_tag']} " . $this->generateAttributes($this->aOptions['input_container_attributes']) . ">" . "<select " . $this->generateAttributes($_aSelectTagAttributes) . " >" . $this->_getDropDownList($this->aField['input_id'], $this->getAsArray($this->aField['label'], true), $this->aField['attributes']) . "</select>" . "</{$this->aOptions['input_container_tag']}>";
    }
    private function _getDropDownList($sInputID, array $aLabels, array $aAttributes) {
        ...
        foreach ($aLabels as $__sKey => $__asLabel) {
            ...
            $_aOutput[] = $this->_getOptionTag($__asLabel, $this->_getOptionTagAttributes($aAttributes, $sInputID, $__sKey, $this->getAsArray($aAttributes['value'], true)));
        }
        return implode(PHP_EOL, $_aOutput);
    }
