<?php 
/**
	Admin Page Framework - Minified Version v3.5.3b02 by Michael Uno 
...
abstract class AdminPageFramework_MetaBox_Model extends AdminPageFramework_MetaBox_Router {
    ...
    public function _replyToFilterSavingData($aPostData, $aUnmodified) {
        ...
        $_aInput = $this->oUtil->addAndApplyFilters($this, "validation_{$this->oProp->sClassName}", is_callable(array($this, 'validate')) ? call_user_func_array(array($this, 'validate'), array($_aInput, $_aSavedMeta, $this)) : $_aInput, $_aSavedMeta, $this);
...
abstract class AdminPageFramework_Form_Model_Validation extends AdminPageFramework_Form_Model_Port {
    ...
    private function _getFilteredOptions($aInput, $aInputRaw, $aStoredData, $aSubmitInformation) {
        ...
        return $this->_getValidatedData("validation_{$this->oProp->sClassName}", is_callable(array($this, 'validate')) ? call_user_func_array(array($this, 'validate'), array($_aData['aInput'], $_aData['aStoredData'], $this, $_aData['aSubmitInformation'])) : $_aData['aInput'], $_aData['aStoredData'], $_aData['aSubmitInformation']);
    }
...
abstract class AdminPageFramework_MetaBox_Page_Model extends AdminPageFramework_MetaBox_Page_Router {
    ...
    public function _replyToValidateOptions($aNewPageOptions, $aOldPageOptions, $oAdminPage, $aSubmitInfo) {
        ...
        $_aNewMetaBoxInput = is_callable(array($this, 'validate')) ? call_user_func_array(array($this, 'validate'), array($_aNewMetaBoxInput, $_aOldMetaBoxInput, $this, $aSubmitInfo)) : $_aNewMetaBoxInput;
...
class AdminPageFramework_Input_select extends AdminPageFramework_Input_Base {
    ...
    private function _getDropDownList($sInputID, array $aLabels, array $aAttributes) {
        ...
        foreach ($aLabels as $__sKey => $__asLabel) {
            ...
            $_aOutput[] = $this->_getOptionTag($__asLabel, $this->_getOptionTagAttributes($aAttributes, $sInputID, $__sKey, $_aValues));
        }
        return implode(PHP_EOL, $_aOutput);
    }
...
class AdminPageFramework_Widget_Factory extends WP_Widget {
    ...
    public function update($aSubmittedFormData, $aSavedFormData) {
        return $this->oCaller->oUtil->addAndApplyFilters($this->oCaller, "validation_{$this->oCaller->oProp->sClassName}", is_callable(array($this->oCaller, 'validate')) ? call_user_func_array(array($this->oCaller, 'validate'), array($aSubmittedFormData, $aSavedFormData, $this->oCaller)) : $aSubmittedFormData, $aSavedFormData, $this->oCaller);
    }
