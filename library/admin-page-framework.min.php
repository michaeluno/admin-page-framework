<?php 
/**
	Admin Page Framework - Minified Version v3.3.2b02 by Michael Uno 
...
"; return $_sCSS . PHP_EOL . self::_getFormFieldRules() . PHP_EOL . self::_getFieldErrorRules() . PHP_EOL . self::_getMetaBoxFormRules() . PHP_EOL . self::_getWidgetFormRules() . PHP_EOL . self::_getPageLoadStatsRules() . PHP_EOL . self::_getVersionSpecificRules( $GLOBALS['wp_version'] ); } static private function _getFormFieldRules() { return "
/* Form Elements */
...
"; } static private function _getMetaBoxFormRules() { return "/* Meta-box form fields */
.postbox .title-colon {
    margin-left: 0.2em;
}
...
"; } static private function _getVersionSpecificRules( $sWPVersion ) { $_sCSSRules = ''; if ( version_compare( $sWPVersion, '3.8', '<' ) ) { $_sCSSRules .= "
...
"; } if ( version_compare( $sWPVersion, '3.8', '>=' ) ) { $_sCSSRules .= "
/* Widget Forms */
