<?php 
/**
	Admin Page Framework - Minified Version v3.5.3b06 by Michael Uno 
...
abstract class AdminPageFramework_Form_Model_Port extends AdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        ...
        return $bMerge ? $this->oUtil->uniteArrays($vData, $aStoredOptions) : $vData;
    }
...
class AdminPageFramework_Debug extends AdminPageFramework_WPUtility {
    ...
    static private function _getLogContents($mValue) {
        $_iLengths = is_string($mValue) || is_integer($mValue) ? strlen($mValue) : (is_array($mValue) ? count($mValue) : null);
        return '(' . gettype($mValue) . (null !== $_iLengths ? ', length: ' . $_iLengths : '') . ') ' . self::getAsString($mValue) . PHP_EOL . PHP_EOL;
    }
