<?php 
/**
	Admin Page Framework - Minified Version v3.2.0b02 by Michael Uno 
...
"; } static private function _getVersionSpecificRules( $sWPVersion ) { if ( version_compare( $sWPVersion, '3.8', '>=' ) ) { return ".widget .form-table th {
    font-size: 13px;
    font-weight: normal;
}
