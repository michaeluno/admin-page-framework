<?php 
/**
	Admin Page Framework - Minified Version v3.5.3b08 by Michael Uno 
...
abstract class AdminPageFramework_Form_Model_Export extends AdminPageFramework_Form_Model_Import {
    ...
    private function _getFilteredExportingData(array $aArguments, $mData) {
        return $this->oUtil->addAndApplyFilters($this, $this->_getExportFilterHookNames('export_', $aArguments), $mData, $aArguments['pressed_field_id'], $aArguments['pressed_input_id'], $this);
    }
    private function _getExportFileName(array $aArguments, $sExportFileName, $mData) {
        return $this->oUtil->addAndApplyFilters($this, $this->_getExportFilterHookNames('export_name_', $aArguments), $sExportFileName, $aArguments['pressed_field_id'], $aArguments['pressed_input_id'], $mData, $this);
    }
    private function _getExportFormatType(array $aArguments, $sExportFileFormat) {
        return $this->oUtil->addAndApplyFilters($this, $this->_getExportFilterHookNames('export_format_', $aArguments), $sExportFileFormat, $aArguments['pressed_field_id'], $aArguments['pressed_input_id'], $this);
    }
...
abstract class AdminPageFramework_Form_Model_Import extends AdminPageFramework_Router {
    ...
    private function _getImportMIMEType(array $aArguments) {
        return $this->oUtil->addAndApplyFilters($this, $this->_getImportFilterHookNames('import_mime_types_', $aArguments), array('text/plain', 'application/octet-stream'), $aArguments['pressed_field_id'], $aArguments['pressed_input_id'], $this);
    }
    private function _getImportFormatType(array $aArguments, $sFormatType) {
        return $this->oUtil->addAndApplyFilters($this, $this->_getImportFilterHookNames('import_format_', $aArguments), $sFormatType, $aArguments['pressed_field_id'], $aArguments['pressed_input_id'], $this);
    }
    private function _getImportOptionKey(array $aArguments, $sImportOptionKey) {
        return $this->oUtil->addAndApplyFilters($this, $this->_getImportFilterHookNames('import_option_key_', $aArguments), $sImportOptionKey, $aArguments['pressed_field_id'], $aArguments['pressed_input_id'], $this);
    }
    private function _getFilteredImportData(array $aArguments, $mData, $aStoredOptions, $sFormatType, $sImportOptionKey) {
        return $this->oUtil->addAndApplyFilters($this, $this->_getImportFilterHookNames('import_', $aArguments), $mData, $aStoredOptions, $aArguments['pressed_field_id'], $aArguments['pressed_input_id'], $sFormatType, $sImportOptionKey, $aArguments['should_merge'] . $this);
    }
