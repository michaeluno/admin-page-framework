<?php 
/**
	Admin Page Framework - Minified Version v3.5.3b26 by Michael Uno 
    ...
    public function setDynamicElements($aOptions) {
        ...
        foreach ($aOptions as $_sSectionID => $_aSubSectionOrFields) {
            ...
            foreach ($_aSubSectionOrFields as $_isIndexOrFieldID => $_aSubSectionOrFieldOptions) {
                ...
                $_aSubSection[$_iIndex] = !empty($_aSubSection[$_iIndex]) ? $_aSubSection[$_iIndex] : $this->getElementAsArray($_aSubSection, $_iPrevIndex, array());
