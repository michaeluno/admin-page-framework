...
= 2.1.2 =
* Added: the `admin-page-framework-radio-label` class selector for the elements enclosing radio input labels and removed `display:inline-block` from the inline CSS rule of the elements.
