...
/* Inline Mixed Fields 3.8.0+ */
.admin-page-framework-field-_mixed {
    width: 98%;
}
.admin-page-framework-field-_mixed > fieldset {
    display: inline-block;
    overflow-x: visible;    /* Disable scrollbars */
}
.admin-page-framework-field-_mixed > fieldset > .admin-page-framework-fields
{
    /* display: inline; */
    display: inline;
    width: auto;
...
.admin-page-framework-field-_mixed > fieldset > .admin-page-framework-fields > .admin-page-framework-field {
    float: none;
    clear: none;
    width: 100%;    
    display: inline-block;
...
.admin-page-framework-field-_mixed > fieldset > .admin-page-framework-fields > .admin-page-framework-field .admin-page-framework-input-label-string {
    padding: 0;
}
.admin-page-framework-field-_mixed > fieldset > .admin-page-framework-fields > .admin-page-framework-field > .admin-page-framework-input-label-container,
.admin-page-framework-field-_mixed > fieldset > .admin-page-framework-fields > .admin-page-framework-field > * > .admin-page-framework-input-label-container
{
    padding: 0;
    display: inline-block;
...
.admin-page-framework-field-_mixed > fieldset > .admin-page-framework-fields > .admin-page-framework-field > .admin-page-framework-input-label-container > label,
.admin-page-framework-field-_mixed > fieldset > .admin-page-framework-fields > .admin-page-framework-field > * > .admin-page-framework-input-label-container > label
{
    display: inline-block;
    width: 100%;  
}
.admin-page-framework-field-_mixed > fieldset > .admin-page-framework-fields > .admin-page-framework-field > .admin-page-framework-input-label-container > label > input,
.admin-page-framework-field-_mixed > fieldset > .admin-page-framework-fields > .admin-page-framework-field > * > .admin-page-framework-input-label-container > label > input
{
    display: inline-block;
    min-width: 100%;
