...
class AdminPageFramework_FormPart_Table extends AdminPageFramework_WPUtility {
    ...
    public function getFormTables( $aSections, $aFieldsInSections, $hfSectionCallback, $hfFieldCallback ) {
        ...
        $_sStructureType = $this->_getSectionsStructureType( $aSections );    
        ...
        $_oDebugInfo = new AdminPageFramework_FormPart_DebugInfo( $_sStructureType );
         ...
         * 
         * @since       3.3.3
         * @since       DEVVER      Changed the name from `_getSectionsFieldsType()`.
         * @return      string
         * @remark      The first iteration item of the given array will be returned,
         */
        private function _getSectionsStructureType( array $aSections=array() ) {
            foreach( $aSections as $_aSection ) {
                return $_aSection[ '_structure_type' ];
            }
        }    
        /**
...
/*                 private function _getDynamicElementFlagFieldInputTag( array $aSection ) {
                    return $this->getHTMLTag( 
                        ...
                        array(
                            'type'  => 'hidden',
                            'name'  => '__dynamic_elements_' . $aSection[ '_structure_type' ] . '[' . $aSection[ 'section_id' ] . ']',
