...
class AdminPageFramework_Format_EachField extends AdminPageFramework_Format_FormField_Base {
    ...
    public function get() {
        ...
        $_oFieldInputNameGenerator = new AdminPageFramework_Generate_FieldInputName(
            $_aField, 
            $this->getAOrB(
        ...
        $_oFieldFlatInputName = new AdminPageFramework_Generate_FlatFieldInputName(
            $_aField,
            $this->getAOrB(
                $_aField[ '_is_multiple_fields' ],
                $this->isIndex,
...
// 3.3.1+ referred by the repeatable field script
// $_oFieldInputNameGenerator = AdminPageFramework_Generate_FieldInputName(
    // $_aField, 
    // $this->getAOrB(
        // $_aField[ '_is_multiple_fields' ],
        // '-fi-',
