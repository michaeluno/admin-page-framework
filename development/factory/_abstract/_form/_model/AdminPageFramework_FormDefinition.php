...
class AdminPageFramework_FormDefinition extends AdminPageFramework_FormDefinition_Base {
     ...
     */
    public function __construct( $sStructureType, $sCapability, $oCaller=null ) {
 ...
 /*    public function addSection( array $aSection ) {
  ...
  /*   public function addField( $asField ) {
        ...
        $_aField = $this->uniteArrays( 
            array( '_structure_type' => $this->sStructureType )
            + $_aField, 
...
/*     public function format() {
        ...
        $this->aSections    = $this->formatSections( $this->aSections, $this->sStructureType, $this->sCapability );
        $this->aFields      = $this->formatFields( $this->aFields, $this->sStructureType, $this->sCapability );
     ...
     * @deprecated  DEVVER
     */
  /*   public function formatSections( array $aSections, $sStructureType, $sCapability ) {
         ...
         * @deprecated  DEVVER
         */
        protected function formatSection( array $aSection, $sStructureType, $sCapability, $iCountOfElements, $oCaller ) {
     ...
     * @since       3.1.1       Added a parameter. Changed to return the formatted sections array.
     */
  /*   public function formatFields( array $aFields, $sStructureType, $sCapability ) {
 ...
 /*        private function _sortFieldsBySectionsOrder( array &$aFields, array $aSections ) {
         ...
         */
        protected function formatField( $aField, $sStructureType, $sCapability, $iCountOfElements, $iSectionIndex, $bIsSectionRepeatable, $oCallerObject ) {
