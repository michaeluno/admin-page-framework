<?php 
/**
	Admin Page Framework - Inclusion Class Files v3.5.0b01 by Michael Uno 
...
$aClassFiles = array( 
	"AdminPageFramework_Documentation"	=>	AdminPageFramework_Registry::$sDirPath . "/document/AdminPageFramework_Documentation.php", 
	"AdminPageFramework_Factory_Documentaiton"	=>	AdminPageFramework_Registry::$sDirPath . "/document/AdminPageFramework_Factory_Documentaiton.php", 
	"AdminPageFramework_FieldType_Documentation"	=>	AdminPageFramework_Registry::$sDirPath . "/document/AdminPageFramework_FieldType_Documentation.php", 
	"AdminPageFramework_MetaBox_Documentation"	=>	AdminPageFramework_Registry::$sDirPath . "/document/AdminPageFramework_MetaBox_Documentation.php", 
	"AdminPageFramework_MetaBox_Page_Documentation"	=>	AdminPageFramework_Registry::$sDirPath . "/document/AdminPageFramework_MetaBox_Page_Documentation.php", 
	"AdminPageFramework_NetworkAdmin_Documentation"	=>	AdminPageFramework_Registry::$sDirPath . "/document/AdminPageFramework_NetworkAdmin_Documentation.php", 
	"AdminPageFramework_PostType_Documentation"	=>	AdminPageFramework_Registry::$sDirPath . "/document/AdminPageFramework_PostType_Documentation.php", 
	"AdminPageFramework_TaxonomyField_Documentaion"	=>	AdminPageFramework_Registry::$sDirPath . "/document/AdminPageFramework_TaxonomyField_Documentaion.php", 
	"AdminPageFramework_Widget_Documentation"	=>	AdminPageFramework_Registry::$sDirPath . "/document/AdminPageFramework_Widget_Documentation.php", 
	...
	"AdminPageFramework_Documentaiton"	=>	AdminPageFramework_Registry::$sDirPath . "/document/AdminPageFramework_Documentation.php", 
